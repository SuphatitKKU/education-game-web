...
const ALL_STORY_SCENES = [
  ...
  ["shot_04_rain_damage.png", "โอ๊ะ! ฝนตกใส่กล่อง น้ำซึมเข้าไปจนกระดาษเปียกและนิ่มลง ลองสังเกตว่ากล่องเปลี่ยนไปอย่างไรบ้าง", "เราจะเก็บรอยเปียกนี้ไว้เป็นหลักฐาน แล้วค่อยหาคำตอบจากการสำรวจกล่อง", "worried", "0% 50%"],
  ["shot_05_stack_pressure.png", "กล่องหลายใบวางซ้อนกัน กล่องของเราจึงถูกน้ำหนักด้านบนกดจนยุบ ลองดูว่ารอยยุบอยู่ตรงไหน", "การวางซ้อนอาจเกี่ยวข้องกับรอยยุบ เราจะหาคำตอบจากหลักฐานที่พบ", "strained", "50% 50%"],
  ["shot_06_corner_impact.png", "ระหว่างขนย้าย กล่องเผลอตกลงพื้น ตุ้บ! มุมกล่องจึงบุบลง แล้วสิ่งของด้านในจะเป็นอย่างไรบ้างนะ", "การตกกระแทกอาจเกี่ยวข้องกับรอยบุบ เราจะไปตรวจดูสิ่งของด้านในกัน", "shocked", "100% 50%"],
...
const ALL_DAMAGES = [
  ...
  { id: "wet", label: "รอยเปียก", title: "รอยเปียกอยู่จุดไหน?", hint: "หมุนไปด้านหลัง แล้วมองหาคราบสีน้ำตาลเข้มเป็นด่างบนผิวกล่อง", evidence: "คราบเปียกน้ำ", position: "1.05m -0.18m -1.35m", normal: "0 0 -1" },
