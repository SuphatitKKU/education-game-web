...
const paperNanoFeatures = (materialName: string): readonly MicroscopeFeature[] => [
  ...
  {
    id: "hydrogen-bonds",
    label: "เส้นประระหว่างโซ่",
    icon: "⋯",
    detail: "เส้นประแสดงตำแหน่งพันธะไฮโดรเจนระหว่างโซ่เซลลูโลส",
    x: 58,
    y: 73,
  },
];
...
const peNanoFeatures: readonly MicroscopeFeature[] = [
  ...
  },
  {
    ...
    icon: "≡",
    detail: "โซ่บางช่วงวางเรียงชิดกันอย่างเป็นระเบียบ เห็นเป็นบริเวณเส้นขนาน",
    x: 70,
    y: 32,
  },
  {
    ...
    icon: "➿",
    detail: "โซ่อีกบางช่วงคดและพันกัน เห็นเป็นเส้นโค้งซ้อนกัน",
    x: 56,
    y: 75,
  },
];
...
export const MATERIAL_MICROSCOPES: Record<MaterialMicroscopeId, { micro: MicroscopeLevel; nano: MicroscopeLevel }> = {
  corrugated_cardboard: {
    micro: {
      ...
      intro: "จากผิวที่ดูเรียบ เมื่อขยายจะเห็นเส้นใยกระดาษไขว้กัน มีช่องว่างเล็ก ๆ และมีกาวอยู่บริเวณที่แผ่นผิวต่อกับลอน",
      visual: "paper",
      features: [
        { id: "paper-fibers", label: "เส้นใยกระดาษ", icon: "≋", detail: "เส้นใยยาวจำนวนมากวางไขว้และเกาะกันเป็นกลุ่ม", x: 25, y: 32 },
        { id: "fiber-pores", label: "ช่องว่างระหว่างเส้นใย", icon: "○", detail: "บริเวณมืดระหว่างเส้นใยเป็นช่องว่างขนาดเล็ก", x: 70, y: 31 },
        { id: "starch-glue", label: "จุดที่เส้นใยเกาะกัน", icon: "●", detail: "บริเวณที่เส้นใยหลายเส้นซ้อนและเกาะกัน เห็นเป็นจุดสีเหลืองหลายจุด", x: 50, y: 56 },
      ],
    },
    nano: {
  ...
  cardboard: {
    micro: {
      ...
      visual: "coated-paper",
      features: [
        { id: "white-coating", label: "ชั้นเคลือบสีขาว", icon: "▰", detail: "แถบบางด้านบนคือชั้นเคลือบสีขาว ผิวดูเรียบและสว่าง", x: 72, y: 20 },
        { id: "pressed-fibers", label: "ชั้นเส้นใยกระดาษ", icon: "≋", detail: "เส้นใยจำนวนมากวางซ้อนและไขว้กันเป็นชั้น", x: 35, y: 43 },
        { id: "gray-recycled-fibers", label: "ช่องว่างระหว่างเส้นใย", icon: "○", detail: "ส่วนสีดำระหว่างเส้นใยคือช่องว่างขนาดเล็ก", x: 66, y: 55 },
      ],
    },
    nano: {
  ...
  bubble_wrap: {
    micro: {
      ...
      features: [
        ...
        { id: "micro-valley", label: "ร่องตื้นระหว่างลาย", icon: "⌄", detail: "ส่วนสีเข้มระหว่างลายคือร่องตื้นมากบนผิว ในภาพนี้ไม่พบรูทะลุผ่านชั้นฟิล์ม", x: 50, y: 57 },
      ],
    },
    nano: {
      eyebrow: "ภาพจริงจากกล้อง AFM",
      ...
      features: [
        ...
        { id: "nano-valley", label: "ร่องสีเข้มที่ต่ำกว่า", icon: "▼", detail: "บริเวณสีน้ำตาลเข้มคือร่องเล็ก ๆ บนผิว ไม่ใช่รูทะลุ", x: 72, y: 36 },
        { id: "nano-roughness", label: "ขรุขระเฉลี่ย 2.5 นาโนเมตร", icon: "≋", detail: "บริเวณที่สีสว่างและเข้มสลับกันแสดงความขรุขระ เฉลี่ย 2.5 นาโนเมตร", x: 50, y: 58 },
      ],
    },
  },
  closed_cell_pe_foam: {
    micro: {
      ...
      visual: "foam",
      features: [
        { id: "closed-cells", label: "ห้องอากาศปิด", icon: "⬡", detail: "ส่วนมืดคือห้องอากาศเล็ก ๆ ที่แยกจากกันด้วยผนังพลาสติกบาง", x: 25, y: 32 },
        { id: "cell-wall", label: "ผนังพลาสติกบาง", icon: "⬢", detail: "เส้นสว่างที่กั้นแต่ละห้องคือผนัง PE บาง ๆ", x: 50, y: 44 },
        { id: "trapped-gas", label: "อากาศที่อยู่ภายในห้อง", icon: "•", detail: "บริเวณมืดภายในห้องคืออากาศที่อยู่ในแต่ละช่อง", x: 74, y: 58 },
      ],
    },
    nano: {
      eyebrow: "ภาพจริงจากกล้อง SEM",
      ...
      features: [
        ...
        { id: "amorphous-pe", label: "ส่วน PE ที่ไม่เรียงตัว", icon: "~", detail: "พื้นที่มืดระหว่างแผ่นผลึกคือส่วนของ PE ที่โซ่ไม่เรียงตัวเป็นระเบียบ", x: 72, y: 37 },
        { id: "wall-matrix", label: "เนื้อผนังโฟม PE", icon: "▰", detail: "บริเวณที่มีแผ่นผลึกสว่างกระจายในพื้นมืดคือเนื้อผนังโฟม", x: 50, y: 58 },
      ],
    },
  },
  pe_sheet: {
    micro: {
      ...
      visual: "pe-film",
      features: [
        { id: "continuous-surface", label: "ผิวเรียบต่อเนื่อง", icon: "▱", detail: "พื้นสีเทาที่ต่อเนื่องคือผิว LDPE จริง ผิวดูเรียบต่อเนื่องและไม่เห็นช่องเปิดขนาดใหญ่", x: 28, y: 34 },
        ...
        { id: "no-large-openings", label: "ไม่มีช่องเปิดใหญ่", icon: "◯", detail: "ในภาพนี้ไม่พบรูเปิดขนาดใหญ่ทะลุผิว", x: 51, y: 58 },
      ],
    },
    nano: {
      eyebrow: "ภาพจริงจากกล้อง AFM",
      ...
      features: [
        ...
        { id: "afm-valley", label: "ร่องต่ำสีเข้ม", icon: "▼", detail: "บริเวณสีน้ำตาลเข้มคือร่องตื้นมากบนผิว ไม่ใช่รูทะลุ", x: 67, y: 38 },
        { id: "afm-roughness", label: "ขรุขระเฉลี่ย 3.4 นาโนเมตร", icon: "≋", detail: "ผิวตัวอย่างมีความขรุขระเฉลี่ย 3.4 นาโนเมตร", x: 51, y: 58 },
      ],
    },
  },
};
